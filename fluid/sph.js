...
function animationLoopf() {
  ...
  const ctx = document.getElementById("fluid").getContext("2d");
...
function sizeCanvasf() {
  const canvas = document.getElementById("fluid");
  widthf = document.getElementById("project-canvas-f").clientWidth;
  widthf -= widthf % cellSize;
  heightf = document.getElementById("project-canvas-f").clientHeight;
